...
class SocketTemp internal constructor(internal var dstAddress: String, internal var dstPort: Int) : AsyncTask<String, String, Void>() {
    ...
    lateinit internal var textTemperature: TextView
    lateinit internal var btn_click: Button

    fun addComponents(textTemperature: TextView, textResponse: TextView, btn_click: Button) {
    ...
    override fun onPostExecute(result: Void?) {
        ...
        try {
            ...
            textTemperature.text = obj.getString("sensor") + " C"
